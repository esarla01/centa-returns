  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-100">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between sm:px-5 lg:px-6 mt-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <div className="flex-col items-center gap-4">
                    <h2 className="text-2xl font-bold text-gray-800">
                        {(search || typeFilter) ? `Arama Sonuçları` : 'Tüm Ürüm Modelleri'}
                    </h2>
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <div className="relative">
                ...
                <select value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} className="pl-10 pr-4 appearance-none w-full border border-gray-300 rounded-md py-2 px-3 bg-white focus:outline-none focus:ring-2">
                  ...
                  <option value="door_detector">Door Detector</option>
                  <option value="control_unit">Control Unit</option>
                </select>
              </div>
